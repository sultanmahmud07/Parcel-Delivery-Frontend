...
import DonateNow from './DoneteNow'
      ...
      <div className='flex items-center min-h-screen '>
        <div className="main-container pt-32 md:pt-16 flex flex-col md:flex-row md:items-center gap-8 md:gap-10">
          <div className="w-full md:w-3/5 flex flex-col gap-4 md:gap-6">
            <h5 className='text-orange font-bold uppercase'>TRUSTED CHARITY COMPANY</h5>
            <h1 className='banner_title text-white font-semibold capitalize text-3xl md:text-4xl lg:text-[2.55rem]'>Let&apos;s Make a Difference And Make People Smile By <span className='text-primary'>Giving</span> Of Yours </h1>
            <p className='text-white font-bold'>No matter how small the donation you give will mean a lot to them, let&apos;s donate now to help fellow humans in need</p>
            <div className="flex items-center gap-5 lg:gap-14">
              <Link to={"/contact"}>
              <button type="button" className='transition-transform duration-500 hover:scale-105 bg-gradient-to-r from-primary to-secondary p-2 md:p-4 px-4 md:px-10 rounded md:rounded-lg text-white font-bold capitalize'>Get Started</button>
              </Link>
              <img
                src={playIcon}
                alt="logo"
