  ...
  return (
    <section className="relative md:mb-32  bg-gradient-to-r from-primary to-secondary">
      <div className='flex items-center min-h-screen '>
        <div className="main-container pt-32 md:pt-16 flex flex-col md:flex-row md:items-center gap-16 md:gap-10">
          ...
          <div className="image_banner w-full md:w-2/5 ">
            <div className="image_con relative">
              <img
                src={bannerIcon}
                alt="logo"
                className="w-1/2 bg-gradient-to-r from-primary to-secondary  rounded-3xl transition-transform duration-500 hover:scale-105 md:w-1/2 absolute top-[-50px] right-[-20px] md:right-[-50px]"
              // sizes="100vw"
              />
              <img
                src={bannerImg}
